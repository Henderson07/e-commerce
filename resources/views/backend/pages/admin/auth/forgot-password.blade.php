...
@section('content')
    ...
    <div class="login-box bg-white box-shadow border-radius-10">
        <div class="login-title">
            <h2 class="text-center text-primary">Esqueci a senha</h2>
        </div>
        <h6 class="mb-20">
            Adicione seu email para a recuperação da senha
        </h6>
        <form action="{{ route('admin.send-password-reset-link') }}" method="POST">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-5">
                    <div class="input-group mb-0">
                        <a class="btn btn-outline-primary btn-lg btn-block" href="{{ route('admin.login') }}">Logar</a>
                    </div>
                </div>
            </div>
        </form>
