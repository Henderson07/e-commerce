...
@section('content')
    ...
    <div class="login-box bg-white box-shadow border-radius-10">
        ...
        <form action="{{ route('admin.login_handler') }}" method="POST">
            ...
            @error('password')
                <div class="d-block text-danger" style="margin-top: -25px !important; margin-bottom:15px !important;">
                    {{ $message }}
                </div>
            @enderror
            <div class="row pb-30">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    {{-- <div class="input-group mb-0">
                        <a class="btn btn-outline-primary btn-lg btn-block" href="register.html">Registre-se e crie sua conta</a>
                    </div> --}}
                </div>
            </div>
        </form>
